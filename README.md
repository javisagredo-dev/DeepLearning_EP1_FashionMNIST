...
- `notebooks/fashion_mnist_mlp.ipynb`: cuaderno con todo el desarrollo. Incluye la carga y el
...
1. Abrir el cuaderno en Colab:
   https://colab.research.google.com/github/javisagredo-dev/DeepLearning_EP1_FashionMNIST/blob/main/notebooks/fashion_mnist_mlp.ipynb
...
jupyter notebook notebooks/fashion_mnist_mlp.ipynb
```
